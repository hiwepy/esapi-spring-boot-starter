...
**Spring Boot Starter for esapi**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/esapi-spring-boot-starter)](https://github.com/easy-4-java/esapi-spring-boot-starter)
...
> **Artifact ID**：`esapi-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**esapi-spring-boot-starter** is a Spring Boot starter that integrates **esapi** for applications using esapi. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume esapi capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using esapi |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for esapi |
| JDK | `17` |
| Coordinates | `io.github.easy4j:esapi-spring-boot-starter:3.1.x.20260527-SNAPSHOT` |
| Config Prefix | `esapi` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers esapi beans automatically |
| Property Binding | ✅ Stable | Binds `esapi.*` to `EsapiProperties` |
| `PropertyPlaceholderConfigurer` bean | ✅ Stable | Auto-registered via EsapiAutoConfiguration |
...
|---|---|---|
| `PropertyPlaceholderConfigurer` | classpath + property | not created |
...
|---|---|---|:---:|---|:---:|
| `esapi.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl esapi-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `esapi.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/esapi-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/esapi-spring-boot-starter)
